...
#for inbuilt_webcam put 0, 
#for External_webcam put 1,    
cap = cv2.VideoCapture(0)
detector = dlib.get_frontal_face_detector()

def insertOrUpdate(Id, Name) :                                            # this function is for database
    connect = sqlite3.connect("Face-DataBase.db")                                  # connecting to the database
...
Id = input("Enter student's Roll Number : ")
insertOrUpdate(Id, name)                                                  # calling the sqlite3 database
